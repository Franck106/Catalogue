...
public class InitDataSet {
	...
	public void initData() throws NoSuchAlgorithmException {
		...
		insertProposal("Soin & Bien être", "Coiffeuse à domicile ou en déplacement, disponible et efficace.", "bien_etre.png", 20, 1, 79);
		insertProposal("Soin & Bien être", "Esthéticienne certifiée et spécialisée dans les publics fragiles (profession para médicale reconnue comme soin de support en oncologie), les soins que je propose sont adaptés à la personne et à sa situation.", "bien_etre.png", 35, 1, 72);
		insertProposal("Soin & Bien être", "Coucou les filles , je vous propose le rehaussement des cils qui sublimera votre regard. Avec teinture si vous le souhaitez. Le rehaussement dure entre 2 et 3 mois. ", "bien_etre.png", 30, 1, 14);
		insertProposal("Soin & Bien être", "Je vous propose des soins esthétiques de qualité avec des produits professionnels (épilation toutes zones, soins de mains et des pieds, maquillage, conseils en image), je suis aussi prothésiste ongulaire.", "bien_etre.png", 60, 1, 39);
		insertProposal("Soin & Bien être", "Masseuse expérimentée et délicate, je propose des massages de 30min à 2h à petits prix.", "bien_etre.png", 50, 1, 12);
		insertProposal("Soin & Bien être", "Esthéticienne à domicile passionnée et diplômée depuis plus de 10ans. Je vous propose un moment de detente privilégié sans bouger de chez vous", "bien_etre.png", 30, 1, 74);
		insertProposal("Soin & Bien être", "Je suis Esthéticienne depuis maintenant plus de 6 ans. Je propose mes services à mon domicile.", "bien_etre.png", 25, 1, 22);
